# CompDeskTicketingSystem

**Lightweight, privacy-first, self-hosted help desk and ticketing.**

> **Unofficial fork notice:** This project is an unofficial fork of
> [CompDesk](https://github.com/TahaHydra/CompDesk), originally created by
> [Taha Laachari / xHydra](https://github.com/TahaHydra) and licensed under the MIT License.
> This fork is **not affiliated with, sponsored by, or endorsed by** Taha Laachari or xHydra.
> All credit for the original code belongs to the original author. See [NOTICE](NOTICE) and [LICENSE](LICENSE).

[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
[![Upstream: CompDesk](https://img.shields.io/badge/upstream-TahaHydra%2FCompDesk-blue)](https://github.com/TahaHydra/CompDesk)
